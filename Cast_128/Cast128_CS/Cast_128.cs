    ...
    public class Cast_128
    {
        ...
        private string GetBlocksString(List<Block> encrypredOrDecryoBlocks)
        {
            ...
            foreach (Block block in encrypredOrDecryoBlocks)
            {
                ...
                foreach (char c in bytesData.Select(b => ((char)b)).ToArray())
                {
        ...
        {
            //return Convert.ToUInt32((Convert.ToUInt64(a) + Convert.ToUInt64(b)) % Math.Pow(2, 32));
            return Convert.ToUInt32((a + b) % Math.Pow(2, 32));
        }
        public static uint subtractMod2_32(uint a, uint b)
        {
            ...
            return Convert.ToUInt32((Math.Pow(2, 32) + Convert.ToUInt64(a)) - Convert.ToUInt64(b));
        }
